...
namespace UI
{
    public class OarExperimentUI : ExperimentUI
    {
        [SerializeField] private UIDocument oarExperimentUI;

        private void Start()
        {
            oarExperimentUI.enabled = false;
        }
        ...
        public override void Show(IMessage message)
        {
            ...
            if (msg.zoneType != ZoneType.OarExperiment) return;
            oarExperimentUI.enabled = true;
        }
